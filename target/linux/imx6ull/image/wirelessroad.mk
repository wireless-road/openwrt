...
define Device/lorawan_gateway_ethernet_bridged
	DEVICE_TITLE := Lorawan Gateway Ethernet Bridged
	DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-spi-dev
	DEVICE_NAME := lorawan_gateway_ethernet_bridged
	DEVICE_DTS := lorawan_gateway_ethernet_bridged
	BOARDNAME := WIRELESSROAD_GW_IMX6ULL
	SUPPORTED_DEVICES:= wirelessroad_gw-imx6ull lorawan_gateway_ethernet_bridged
	IMAGE_SIZE := 31m
	...
	IMAGE/mtd-factory.bin := append-kernel | append-rootfs | pad-rootfs | imx6ull-mtd-factory | append-metadata | check-size $$$$(IMAGE_SIZE_FACTORY)
endef
TARGET_DEVICES += lorawan_gateway_ethernet_bridged
...
define Device/tensorflow_wifi
	DEVICE_TITLE := Tensorflow Wifi
	DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-spi-dev kmod-wfx iwinfo wpad-mini
	DEVICE_NAME := tensorflow_wifi
	DEVICE_DTS := tensorflow_wifi
	BOARDNAME := WIRELESSROAD_TENSORFLOW_WIFI_IMX6ULL
	SUPPORTED_DEVICES := wirelessroad_tensorflow_wifi-imx6ull tensorflow_wifi
	IMAGE_SIZE := 31m
	IMAGE_SIZE_FACTORY := 32m
	CONSOLE := ttymxc0,115200
	KERNEL := kernel-bin | buildDtb | append-dtb | uImage none | imx6ull-bootscript
	...
	IMAGE/mtd-factory.bin := append-kernel | append-rootfs | pad-rootfs | imx6ull-mtd-factory | append-metadata | check-size $$$$(IMAGE_SIZE_FACTORY)
endef
TARGET_DEVICES += tensorflow_wifi

define Device/tensorflow_wifi_dev
	DEVICE_TITLE := Tensorflow Wifi Dev
	DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-spi-dev kmod-wfx iwinfo wpad-mini
	DEVICE_NAME := tensorflow_wifi_dev
	DEVICE_DTS := tensorflow_wifi
	BOARDNAME := WIRELESSROAD_TENSORFLOW_WIFI_DEV_IMX6ULL
	SUPPORTED_DEVICES := wirelessroad_tensorflow_wifi_dev-imx6ull tensorflow_wifi_dev
	IMAGE_SIZE := 31m
	IMAGE_SIZE_FACTORY := 32m
	CONSOLE := ttymxc0,115200
	KERNEL := kernel-bin | buildDtb | append-dtb | uImage none | imx6ull-bootscript
...
define Device/gs
        ...
        DEVICE_DTS := gs
        BOARDNAME := WIRELESSROAD_FLEXCAN_WIFI_IMX6ULL
        SUPPORTED_DEVICES := wirelessroad_stream-imx6ull gs
        IMAGE_SIZE := 15m
        IMAGE_SIZE_FACTORY := 16m
        CONSOLE := ttymxc0,115200
        KERNEL := kernel-bin | buildDtb | append-dtb | uImage none | imx6ull-bootscript
